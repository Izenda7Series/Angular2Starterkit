...
@Component({templateUrl: 'advancedreportpart.component.html', styleUrls: ['advancedreportpart.component.css']})
...
export class AdvancedReportPart implements AfterViewInit {
    ...
    updateResultReportPart(p1filter : string) {
        ...
        this
            .izItergrate
            .UpdateResultReportPart(reportPartId, overridingFilterValue, "update-result");
        this
            .izItergrate
            .HideIzenaProgressBar('update-result', 'reportPartLoader');
    }
    ...
    displayPart(partNumber : number) {
        ...
        this
            .izItergrate
            .RenderSingleReportPart(reportPartId, "update-alone");
        this
            .izItergrate
            .HideIzenaProgressBar('update-alone', 'reportPartLoader');
    }
}