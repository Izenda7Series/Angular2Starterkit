...
{
    /// <summary>
    /// The class is corresponding with Izenda Tenant.
    /// </summary>
    public class Tenant
    {
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        /// <summary>
        /// Override to config model creating with tenant information.
        /// </summary>
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            user.Property(u => u.TenantId)
                .HasColumnAnnotation("Index", new IndexAnnotation(
                    new IndexAttribute("TenantIdIndex") { IsUnique = true, Order = 2 }));
        }
                ...
                if (user != null)
                {
                      ...
                      && u.TenantId == user.TenantId))
                    {
                        errors.Add(new DbValidationError("User",
                          string.Format("Username {0} is already taken for Tenant Id {1}",
                    ...
                    {
                        errors.Add(new DbValidationError("User",
                          string.Format("Email Address {0} is already taken for Tenant Id {1}",
                            user.UserName, user.TenantId)));
                    }
                }
                else
