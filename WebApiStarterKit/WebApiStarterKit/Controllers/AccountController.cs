...
using WebApiStarterKit.Providers;
using WebApiStarterKit.Results;
using WebApiStarterKit.IdentityManagers;
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            else
            {
                ...
                {
                    throw new Exception($"Cannot save new user {user.Email} into Izenda System database", ex);
                }
            }
